...
public class ChecksumWritableBlobStoreFormatTests extends OpenSearchTestCase {
    ...
    private final ChecksumWritableBlobStoreFormat<IndexMetadata> clusterBlocksFormat = new ChecksumWritableBlobStoreFormat<>("index-metadata", IndexMetadata::readFrom);
