...
public class RemoteCoordinationMetadataTests extends OpenSearchTestCase {
    ...
    public void testClusterUUID() {
        ...
        RemoteCoordinationMetadata remoteObjectForUpload = new RemoteCoordinationMetadata(coordinationMetadata, METADATA_VERSION, clusterUUID, compressor, namedXContentRegistry);
        assertThat(remoteObjectForUpload.clusterUUID(), is(clusterUUID));

        RemoteCoordinationMetadata remoteObjectForDownload = new RemoteCoordinationMetadata(TEST_BLOB_NAME, clusterUUID, compressor,
    ...
    public void testBlobPathTokens() {
        ...
        RemoteCoordinationMetadata remoteObjectForDownload = new RemoteCoordinationMetadata(uploadedFile, clusterUUID, compressor, namedXContentRegistry);
    ...
    private CoordinationMetadata getCoordinationMetadata() {
        return CoordinationMetadata.builder().term(TERM).lastAcceptedConfiguration(new VotingConfiguration(Set.of("node1")))
