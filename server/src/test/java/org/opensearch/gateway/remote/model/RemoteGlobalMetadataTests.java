...
public class RemoteGlobalMetadataTests extends OpenSearchTestCase {
    ...
    public void testClusterUUID() {
        RemoteGlobalMetadata remoteObjectForDownload = new RemoteGlobalMetadata(TEST_BLOB_NAME, clusterUUID, compressor,
    ...
    public void testBlobPathTokens() {
        ...
        RemoteGlobalMetadata remoteObjectForDownload = new RemoteGlobalMetadata(uploadedFile, clusterUUID, compressor, namedXContentRegistry);
    ...
    public void testBlobPathParameters() {
        RemoteGlobalMetadata remoteObjectForDownload = new RemoteGlobalMetadata(TEST_BLOB_NAME, clusterUUID, compressor, namedXContentRegistry);
    ...
    public void testSerDe() throws IOException {
        ...
        try (InputStream inputStream = GLOBAL_METADATA_FORMAT.serialize(globalMetadata, TEST_BLOB_FILE_NAME, compressor, RemoteClusterStateUtils.FORMAT_PARAMS)
            .streamInput()) {
            RemoteGlobalMetadata remoteObjectForDownload = new RemoteGlobalMetadata(TEST_BLOB_NAME, clusterUUID, compressor, namedXContentRegistry);
    ...
    private Metadata getGlobalMetadata() {
        return Metadata.builder()
            ...
            .coordinationMetadata(CoordinationMetadata.builder().term(TERM).lastAcceptedConfiguration(new VotingConfiguration(Set.of("node1")))
