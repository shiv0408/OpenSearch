...
public class RemotePersistentSettingsMetadataTest extends OpenSearchTestCase {
    ...
    public void testClusterUUID() {
        ...
        RemotePersistentSettingsMetadata remoteObjectForUpload = new RemotePersistentSettingsMetadata(settings, METADATA_VERSION, clusterUUID, compressor, namedXContentRegistry);
        assertThat(remoteObjectForUpload.clusterUUID(), is(clusterUUID));

        RemotePersistentSettingsMetadata remoteObjectForDownload = new RemotePersistentSettingsMetadata(TEST_BLOB_NAME, clusterUUID, compressor,
    ...
    public void testBlobPathTokens() {
        ...
        RemotePersistentSettingsMetadata remoteObjectForDownload = new RemotePersistentSettingsMetadata(uploadedFile, clusterUUID, compressor, namedXContentRegistry);
