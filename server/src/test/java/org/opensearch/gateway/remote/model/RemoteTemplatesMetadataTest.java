...
public class RemoteTemplatesMetadataTest extends OpenSearchTestCase {
    ...
    public void testClusterUUID() {
        ...
        RemoteTemplatesMetadata remoteObjectForUpload = new RemoteTemplatesMetadata(settings, METADATA_VERSION, clusterUUID, compressor, namedXContentRegistry);
        assertThat(remoteObjectForUpload.clusterUUID(), is(clusterUUID));

        RemoteTemplatesMetadata remoteObjectForDownload = new RemoteTemplatesMetadata(TEST_BLOB_NAME, clusterUUID, compressor,
    ...
    public void testBlobPathTokens() {
        ...
        RemoteTemplatesMetadata remoteObjectForDownload = new RemoteTemplatesMetadata(uploadedFile, clusterUUID, compressor, namedXContentRegistry);
